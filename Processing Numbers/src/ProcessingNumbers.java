...
public class ProcessingNumbers {
	...
	public static void main(String[] args) {
		...
		if(x<1){throw new IllegalArgumentException("Start over. Positive integer only");}
		System.out.print("Enter all of your numbers: ");
		...
		for (int i=1;i<x;i++){//I already have the first number so I need one less loop
